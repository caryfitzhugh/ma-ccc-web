...
class ChangesInPrecipitationChangesPage extends Component {
  render() {
    ...
    return (<ChangesLayout
        ...
        <p>Precipitation changes will vary from one part of the state to another due to factors like topography and proximity to the coast.  The <MapLink>resilient MA Map</MapLink>  and <DatagrapherLink>Data Grapher</DatagrapherLink> can help local governments examine precipitation trends in their area, and identify actions to build their long-term resilience to the changes ahead.</p>
        </ChangesLayout>
    );
  }
}
