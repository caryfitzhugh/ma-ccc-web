        ...
        sections={[
          ...
          {title: "More Impacts from Rising Temperatures",
           ...
           content: <div>
            ...
            subsections: [
              {name: <SearchLink params={{query:"rising temperatures agricultural"}}>Agriculture and Livestock </SearchLink>,
              id: "ag_and_livestock",
              content: <div>
              ...
              {name: <SearchLink params={{query:"rising temperatures fisheries"}}>Aquatic Habitats</SearchLink>,
              id: "aquatic_habitats",
              content: <div>
              ...
              {name: <SearchLink params={{query:"rising temperatures natural resources"}}>Terrestrial Habitats</SearchLink>,
              ...
              {name: <SearchLink params={{query:"rising temperatures energy infrastructure"}}> Energy Systems and Infrastructure </SearchLink>,
              ...
              {name: <SearchLink params={{query: "rising temperatures drought"}}>Drought and Wildfires</SearchLink>,
