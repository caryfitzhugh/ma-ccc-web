...
class SeaLevelRiseChangesPage extends Component {
  render() {
    ...
    return (<ChangesLayout
        ...
        <p>
          Sea level rise is already causing coastal flooding and erosion in Massachusetts communities and coastal habitats. Continued sea level rise could further impact public and private infrastructure, water quality, energy systems, and public health.  Sea level rise projections for Boston are shown in Table 1. These projections do not include recent modeling efforts of Antarctic ice sheet collapse, but ongoing collaboration with the UMass Amherst team will incorporate these adjustments in an upcoming updated sea level rise guidance document.
        </p>
        <p>
