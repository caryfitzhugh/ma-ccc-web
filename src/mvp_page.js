          ...
          <div className='container'>
            <SectorDetailLayout
              ...
              { title: "Do you live in an MVP community?",
                ...
                <p>Building on the Administration’s approach to state and local partnerships, the MVP program awards municipalities with funding and technical support to complete a community-led planning process to:
                  <ul>
                    <li>Define extreme weather and natural and climate related hazards</li>
                    <li>Identify existing and future vulnerabilities and strengths</li>
                    <li>Develop and prioritize actions and opportunities for the communities to reduce risk and build resilience</li>
                  </ul>
                </p>
                <p>Once a municipality has completed the planning process they become eligible for follow-on funding opportunities, including MVP implementation grants, and advanced standing in other grant opportunities.</p>
