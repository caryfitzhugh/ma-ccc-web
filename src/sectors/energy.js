          ...
          { title: "Impacts",
            ...
            subsections: [
              {name: <ESearchLink changes={["ma::rising temperatures::"]}>Rising Temperatures</ESearchLink>,
                ...
                content: <div>
                  <p>An average increase in temperatures in Massachusetts is likely to result in an increased demand for cooling in summer and a decreased demand for heating in winter, a change that could strain aging transmission and distribution systems and existing equipment. Cooling and heating degree-days, or the measure of how much and for how long outside air temperature was higher or lower than a specific base temperature, is often used as a proxy for energy consumption required to cool or heat buildings. The accumulation of summer cooling degree-days is expected to increase over 45% by mid-century and by over 65% by the end of the century. Meanwhile, the accumulation of winter heating degree-days is expected to decrease by more than 5% by mid-century and by more than 10% by the end of the century. Summer daytime energy use already produces current peak system demands; additional increases in cooling energy may put upward pressure on energy prices and further impact the reliability and resilience of energy services. Power outages during days of extreme heat could cause significant economic disruption, public safety risks, and human hardship, especially for the state residents who are most vulnerable to extreme heat.</p>
                </div>
              },
